...
function Miniprojects() {
    ...
    const {miniprojects}=portfolioData;
  return (
    <div>
      <SectionTitle title={"Mini Projects"} />
        ...
        <div className="flex flex-row sm:flex-col gap-5 px-10 sm:px-1 sm:py-10 sm:gap-3">
          <div>
            <img
              ...
              src={miniprojects[selectedItemIndex].photourl}
              alt="project"
            />
          </div>
          <div className="px-5 flex gap-8 flex-col">
            ...
            <h1 className="text-fifth text-xl font-bold py-4">
              {miniprojects[selectedItemIndex].title}
            </h1>
            <p className="text-white sm:w-full">
              {miniprojects[selectedItemIndex].description}
            </p>
            </div>
            <div className='flex gap-10'>
            <a href={miniprojects[selectedItemIndex].giturl} className='text-cyan-400' target='_blank' rel="noreferrer">
                <span class="material-symbols-outlined">open_in_new</span>GitHub Repository
              </a>
              <a href={miniprojects[selectedItemIndex].liveurl} className='text-cyan-400' target='_blank' rel="noreferrer">
